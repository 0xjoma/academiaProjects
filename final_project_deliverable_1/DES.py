...
def testEncryptionAndDecryption():
    ...
    ciphertextFileName = "final_project_deliverable_1/results/ciphertext.txt"  # generated by encrypt process
    # Run the encrypt process
    DES_encrypt(plaintextFileName, secretKeyFileName, ciphertextFileName)

    plaintextFileName2 = "final_project_deliverable_1/results/plaintext2.txt"  # generated by decrypt process
    ...
    ciphertextFileName2 = "final_project_deliverable_1/results/ciphertext2.txt"
    DES_encrypt(plaintextFileName, secretKeyFileName2, ciphertextFileName2)
    plaintextFileName3 = "final_project_deliverable_1/results/plaintext3.txt"
